...
// Command: refresh
func refreshCommand(s *dg.Session, i *dg.InteractionCreate, COMMANDS *[]dg.ApplicationCommand) {
	if isOwner(i) {
...
func aboutCommand(s *dg.Session, i *dg.InteractionCreate) {
    str := "Jag är en bot gjort i Go med hjälp av dg paketet. Min källkod finns på https://github.com/r0x57n/allsvenskanBets." +
           "\n" +
	...
	*/
	...
	var (
		...
		COMMAND_HANDLERS = map[string]func(s *dg.Session, i *dg.InteractionCreate) {
			...
			"refresh": func(s *dg.Session, i *dg.InteractionCreate)       {   refreshCommand(s, i, &COMMANDS) },
			"ommig": func(s *dg.Session, i *dg.InteractionCreate)         {   aboutCommand(s, i)              },
		}
